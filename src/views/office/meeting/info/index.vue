<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="会议地点" prop="roomPlace">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['meeting:info:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['meeting:info:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="infoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="会议名称" align="center" prop="roomName" />
      <el-table-column label="会议地点" align="center" prop="roomPlace" />
...
<!--            v-hasPermi="['meeting:info:edit']"-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="会议名称" prop="roomName">
          <el-input v-model="form.roomName" placeholder="请输入会议名称" />
        </el-form-item>
        <el-form-item label="会议地点" prop="roomPlace">
          <el-input v-model="form.roomPlace" placeholder="请输入会议地点" />
        </el-form-item>
...
<script>
import { listInfo, getInfo, delInfo, addInfo, updateInfo } from "@/api/office/meeting/info";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除会议信息编号为"' + roomIds + '"的数据项？').then(function() {
        return delInfo(roomIds);
      }).then(() => {
        this.getList();
